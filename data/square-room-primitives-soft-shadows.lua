...
s1:set_texture("checker.png")
s2:set_texture("checker.png")
s3:set_texture("checker.png")
s4:set_texture("checker.png")
s5:set_texture("checker.png")
s6:set_texture("checker.png")
s7:set_texture("checker.png")
s8:set_texture("checker.png")
