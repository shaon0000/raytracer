...
bright_light = gr.light({0, 698, -1200}, {0.6, 0.6, 0.6}, {1, 0, 0}, {400,0,0}, {0,0,400}, 30)
orange_light = gr.light({595, 0, -1200}, {0.6, 0.6, 0.0}, {1, 0, 0}, {0, 400, 0}, {0, 0, 400}, 30)
...
b1 = gr.nh_box('b1', {-500, -400, -1700}, 1000)
b1.scale(1, 0.1, 1)

wood_cover = gr.pgram("wood_cover")
wood_cover.scale(1000, 1000, 1000)
