...
mat1 = gr.material({0.5,0.5,1.0}, {0.5, 0.7, 0.5}, 67, 0.0, 0.0)
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 85, 0.0, 0.0)
...
bright_light = gr.light({0, 698, -1200}, {0.5, 0.5, 0.0}, {1, 0, 0}, {400,0,0}, {0,0,400}, 90)
orange_light = gr.light({595, 0, -1200}, {0.0, 0.5, 0.5}, {1, 0, 0}, {0, 400, 0}, {0, 0, 400}, 90)
...
s9 = gr.nh_sphere('s9', {0, 0, -400}, 200)
s9:set_material(mat5)
