...
--white_light = gr.light({2000, 200, -1200}, {0.8, 0.8, 0.3}, {1, 0, 0}, {0,400,0}, {0,0,400})
orange_light = gr.light({0, -400, -1200}, {0.7, 0.5, 0.3}, {1, 0, 0}, {0,0,400}, {400,0,0})

gr.render(scene_root, 'sample.png', 512, 512,
	  {0, 0, 800}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.3, 0.3, 0.3}, {orange_light}, 75.0, 1200.0)
