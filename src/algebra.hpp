...
#define SHOW_BOUND_VOLUME 0
#define MSAA 2
#define SHADOW_SAMPLES 10
#define REF_DEPTH 2
#define REFRACT_DEPTH 3
extern int DOF_SAMPLES;
extern int THREAD_NUM;
#define ENABLE_NORMAL_VIEW 0
...
inline Matrix4x4 operator *(double b, const Matrix4x4& a)
{
  Matrix4x4 ret;
...
struct IntersectionDef {
  int total_intersections;
  Point3D p1;
  double t1;
  Vector3D normal;
  void* intersectedNode;
  IntersectionDef() {
    t1 = 0.0;
...
#define DISABLE_REFLECTION_MASK 0x0001
#define DISABLE_REFRACTION_MASK 0x0010

typedef struct PixelBufDef PixelBuf;
typedef struct RayDef Ray;
typedef struct IntersectionDef Intersection;

// v0 - location of plane
// n - normal of the plane
// ray - line that is passing through the plane.
...
// b - point of interest
// ray - the target ray
// returns the t value at which the distance between the point b and the ray is closest
...
Vector3D refract(Vector3D normal, Vector3D incidence, double n1, double n2);
