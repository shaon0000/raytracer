...
mat1 = gr.material({1.0, 0.1, 0.1}, {0.5, 0.7, 0.5}, 67)
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 85)
mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 55)
mat4 = gr.material({0.7, 0.6, 1.0}, {0.5, 0.4, 0.8}, 45)
...
white_light = gr.light({2000, 200, -1200}, {0.8, 0.8, 0.3}, {1, 0, 0})
orange_light = gr.light({0, 300, 1200}, {0.7, 0.5, 0.3}, {1, 0, 0})

gr.render(scene_root, 'scene.png', 1024, 1024,
